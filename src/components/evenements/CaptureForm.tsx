      ...
      <div className="bg-white rounded-2xl shadow-xl p-6 md:p-8 space-y-6">
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          <input
            type="text"
            placeholder="Prénom"
            className="w-full p-3 border border-slate-200 rounded-xl focus:outline-ocean"
            required
          />
          <input
            type="text"
          ...
          <div className="flex items-center gap-2">
            ...
            <input
              ...
              className="flex-1 p-3 border border-slate-200 rounded-xl focus:outline-ocean"
              required
            />
          </div>

          {/* Select pour le profil */}
          <select
            className="w-full p-3 border border-slate-200 rounded-xl bg-white focus:outline-ocean"
            required
          >
          ...
          {/* Champ projet (optionnel mais utile) */}
          <input
            type="text"
          ...
          <button
            type="submit"
            className="w-full bg-ocean text-white font-bold py-3 rounded-full hover:bg-ocean/90 transition"
          >
